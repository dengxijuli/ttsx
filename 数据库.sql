...
delete from flashkilling;
insert into flashkilling values (7,4,50,10,'2023-5-26 20:00',10);
insert into flashkilling values (8,5,10,10,'2023-5-26 20:00',10);
insert into flashkilling values (9,6,40,10,'2023-5-26 20:00',16);
insert into flashkilling values (9,6,40,10,'2023-5-26 20:00',16);

insert into flashkilling values (10,7,50,10,'2023-5-22 20:00',22);
insert into flashkilling values (11,8,10,10,'2023-5-22 20:00',22);
insert into flashkilling values (12,9,40,10,'2023-5-22 20:00',22);
insert into flashkilling values (13,10,10,10,'2023-5-22 20:00',22);
insert into flashkilling values (14,11,40,10,'2023-5-22 20:00',22);
-- 秒杀商品表
...
select *
from FlashKilling;
update FlashKilling set fk_price = '10.00' where fno = 8;
select * from t_order;
delete from t_order;