...
import com.ttsx.entity.pojo.TblAdmin;
import com.ttsx.entity.vo.OrderInfoBeanVO;
import com.ttsx.entity.vo.OrderIteminfoVO;
...
public interface AdminMapper  extends BaseMapper<TblAdmin> {
    ...
    List<OrderIteminfoVO> selectOrderiteminfo();
