...
public class JWTUtils {
    ...
    private final static String SING = "DX";
...
//        Map<String, Object> tokenInfo = getTokenInfo(creatToken(map, 3600));
        Map<String, Object> tokenInfo = getTokenInfo("eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJuaWNrTmFtZSI6ImFhYWFhIiwicHdkIjoiMWJiZDg4NjQ2MDgyNzAxNWU1ZDYwNWVkNDQyNTIyNTEiLCJleHAiOjE2OTMyNzgxNjQsInB1cnZpZXciOiJVc2VyIiwidXNlcmlkIjoiMyJ9.RduTKpU8c2b7VV8UF7rUhw6tM6i9KkoDQ6ypNBOqRoM");
    ...
    public static String creatToken(Map<String, String> payload, int expireTime) {
        ...
        if (expireTime <= 0) {
            instance.add(Calendar.SECOND, Constant.EXPIRETIME);//默认五小时
        } else {
